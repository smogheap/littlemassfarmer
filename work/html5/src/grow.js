...
function start() {
	...
	LMF.thing.farmer.y = LMF.height - LMF.thing.planet.radius + 25;
...
window.addEventListener("load", function() {
	...
	Object.keys(LMF.json).every(function(key) {
		cbs.push(function(cb) {
			...
			if (LMF.cbs[key]) {
				Object.keys(LMF.cbs[key]).every(function(k) {
					LMF.thing[key][k] = LMF.cbs[key][k].bind(LMF.thing[key]);
